...
SKIP_CHARACTERS = [
    10000001, 10000005, 11000008, 11000009, 11000010, 11000011, 11000013, 11000017,
    ...
    10000901, 11000046, 10000902, 10000903, 10000998, 10000999, 11000998, 11000999
]
...
#   energySkill, skills -> AvatarSkillExcelConfigData
#