...
char_skirk = TemplateList(
    default_rus=Template(
        names=[
            ...
            'Переправы смерти', 'Разум за гранью разума', 'Возвращение в небытие', 'Хаос: Отсечение', 'Змеиного коварства',
        ],
        skills={
    ...
    return_to_oblivion=Template(
        sentences=[
            ...
            ['1:ignore'],
            [],
            ['110:ignore', '120:ignore', '170:ignore', '105:ignore', '115:ignore', '160:ignore'],
        ],
    ),
