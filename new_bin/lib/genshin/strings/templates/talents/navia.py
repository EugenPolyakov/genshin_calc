...
char_navia = TemplateList(
    ...
    default_eng=Template(
        names=[
            ...
            'Rosula Shardshots', 'Gunbrella attack',
        ],
        skills={
    ...
    ceremonial_crystalshot=Template(
        sentences=[
            ['1:ignore'],
            ['6:ignore'],
            [],
            ...
            [],
            [],
            ['0:ignore', '1:ignore', '2:ignore', '3:ignore', '5:ignore', '7:ignore', '9:ignore', '11:ignore'],
            [],
            ['11:ignore', '200:'],
            [],
            ['3:ignore', '15:text_percent_dmg|15'],
            [],
            [],
            [],
            [],
    ...
    ceremonial_crystalshot_eng=Template(
        sentences=[
            ['1:ignore'],
            ['6:ignore'],
            [],
            ...
            ['11:ignore', '200:'],
            [],
            ['3:ignore', '3:ignore', '15:text_percent_dmg|15'],
            [],
            [],
            [],
            [],
