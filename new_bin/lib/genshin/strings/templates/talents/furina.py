...
char_furina = TemplateList(
    ...
    unheard_confession_rus=Template(
        sentences=[
            ['1000:ignore'],
            [],
            ['0.7:text_percent_dmg', '28:text_percent_dmg_max'],
            [],
            ['0.4:text_percent_heal'],
    ...
    unheard_confession_eng=Template(
        sentences=[
            ...
            ['0.7:text_percent_dmg', '28:text_percent_dmg_max'],
            [],
            ['0.4:text_percent_heal', '16:text_percent_heal_max'],
        ],
    ),
    ...
    a_woman_adapts_like_duckweed_in_water=Template(
        sentences=[
            ['250:ignore'],
    ...
    hear_me_let_us_raise_the_chalice_of_love_eng=Template(
        sentences=[
            ...
            [],
            [],
            ['1:ignore', '4:text_percent_heal', '2.9:ignore'],
            [],
            [],
            [],
            [],
