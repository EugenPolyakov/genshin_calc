...
char_mona = TemplateList(
    ...
    genesis_of_starsigns_rus=Template(
        ...
        names=[
            '[Оо]бычная', 'Мерцания водных светил'
        ],
        sentences=[
            [],
            ['2:ignore'],
    ...
    prophecy_of_submersion_eng=Template(
        sentences=[
            ['ignore', 'dmg_reaction_electrocharged', 'dmg_reaction_lunarcharged', 'dmg_reaction_vaporize', 'dmg_reaction_swirl_hydro', 'dmg_reaction_lunarcrystallize', 'duration_frozen'],
        ],
    ),
    prophecy_of_submersion_hex_rus=Template(
        ...
        sentences=[
            ['8:ignore', '15:dmg_reaction_electrocharged', '15:duration_frozen'],
            ['160:text_percent'],
        ],
        results=[
            [0],
    ...
    prophecy_of_submersion_hex_eng=Template(
        ...
        sentences=[
            ['8:ignore', '15:dmg_reaction_electrocharged', '15:dmg_reaction_lunarcharged', '15:dmg_reaction_vaporize', '15:dmg_reaction_swirl_hydro', '15:dmg_reaction_lunarcrystallize', '15:duration_frozen'],
            ['160:text_percent'],
        ],
        results=[
            [0],
