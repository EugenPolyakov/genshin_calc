...
char_xilonen = TemplateList(
    ...
    chiucue_mix=Template(
        sentences=[
            ...
            ['50:text_percent_geo'],
            [],
            ['45:text_percent_pyro'],
            [],
            ['45:text_percent_hydro'],
            [],
            ['60:text_percent_cryo'],
            [],
            ['25:ignore', '6:ignore'],
        ],
    ),
    ...
    imperishable_night_carnival_rus=Template(
        sentences=[
            ...
            [],
            [],
            ['300:normal_base_def_percent'],
            [],
            ['1.5:ignore', '120:text_percent_heal'],
            [],
            ['1:ignore', '15:ignore'],
        ],
    ),
    imperishable_night_carnival_eng=Template(
        sentences=[
            ...
            ['300:normal_base_def_percent'],
            [],
            ['120:text_percent_heal', '1.5:ignore'],
            [],
            ['1:ignore', '15:ignore'],
        ],
    ),
