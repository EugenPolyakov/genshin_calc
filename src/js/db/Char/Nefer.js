...
import { FeatureReactionLunarBloomLike } from "../../classes/Feature2/Reaction/Extended/Lunar/BloomLike";
...
export const Nefer = new DbObjectChar({
    ...
    features: [
        ...
        new FeatureDamageCharged({
            customId: 'skill.nefer_phantasm_performance_1_hit_dmg_nefer',
            element: 'dendro',
            multipliers: [
                new FeatureMultiplier({
        ...
        new FeatureDamageCharged({
            customId: 'skill.nefer_phantasm_performance_2_hit_dmg_nefer',
            element: 'dendro',
            multipliers: [
                new FeatureMultiplier({
                    leveling: 'char_skill_elemental',
