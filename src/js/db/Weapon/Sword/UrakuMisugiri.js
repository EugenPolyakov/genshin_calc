...
export const UrakuMisugiri = new DbObjectWeapon({
    ...
    conditions: [
        new ConditionStaticRefine({
            title: 'talent_name.weapon_brocade_bloom_shrine_sword',
            description: 'talent_descr.weapon_brocade_bloom_shrine_sword_1',
            stats: [
        ...
        new ConditionBooleanRefine({
            ...
            serializeId: 1,
            title: 'talent_name.weapon_brocade_bloom_shrine_sword',
            description: 'talent_descr.weapon_brocade_bloom_shrine_sword_2',
            stats: [
                new StatTable('dmg_normal', [16, 20, 24, 28, 32]),
                new StatTable('dmg_skill', [24, 30, 36, 42, 48]),
            ],
        ...
        new ConditionStaticRefine({
            title: 'talent_name.weapon_brocade_bloom_shrine_sword',
            description: 'talent_descr.weapon_brocade_bloom_shrine_sword_3',
            stats: [
