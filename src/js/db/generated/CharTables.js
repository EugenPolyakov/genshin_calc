...
export const charTables = {
	...
	Albedo: [
		...
		new StatTableAscensionScale({
			stat: 'dmg_geo_base',
			base: 0,
			ascension: new StatTable('', [0, 0.072, 0.144, 0.144, 0.216, 0.288]),
		}),
		new StatTableAscensionScale({
			stat: 'hp_base',
			base: 1029.5856,
	...
	Amber: [
		...
		new StatTableAscensionScale({
			stat: 'atk_percent',
			base: 0,
			ascension: new StatTable('', [0, 0.06, 0.12, 0.12, 0.18, 0.24], 100),
		}),
		new StatTableAscensionScale({
			stat: 'burst_energy_cost',
			base: 40,
	...
	Arlecchino: [
		...
		new StatTableAscensionScale({
			...
			base: 0.5,
			multi: 100,
			ascension: new StatTable('', [0, 0.096, 0.192, 0.192, 0.288, 0.384], 100),
		}),
		new StatTableAscensionScale({
			stat: 'crit_rate_base',
			base: 0.05,
	...
	Baizhu: [
		...
		new StatTableAscensionScale({
			stat: 'hp_percent',
			base: 0,
			ascension: new StatTable('', [0, 0.072, 0.144, 0.144, 0.216, 0.288], 100),
		}),
		new StatTableAscensionScale({
			stat: 'mastery_base',
			base: 0,
	...
	Beidou: [
		...
		new StatTableAscensionScale({
			...
			base: 0,
			ascension: new StatTable('', [0, 0.06, 0.12, 0.12, 0.18, 0.24]),
		}),
		new StatTableAscensionScale({
			stat: 'hp_base',
			base: 1094.1492,
	...
	Bennett: [
		...
		new StatTableAscensionScale({
			...
			base: 1,
			multi: 100,
			ascension: new StatTable('', [0, 0.0667, 0.1333, 0.1333, 0.2, 0.2667], 100),
		}),
	],
	Candace: [
		new StatTableAscensionScale({
	...
	Chasca: [
		...
		new StatTableAscensionScale({
			...
			base: 0.05,
			multi: 100,
			ascension: new StatTable('', [0, 0.048, 0.096, 0.096, 0.144, 0.192], 100),
		}),
		new StatTableAscensionScale({
			stat: 'def_base',
			base: 47.864,
	...
	Jahoda: [
		...
		new StatTableAscensionScale({
			stat: 'healing_base',
			base: 0,
			ascension: new StatTable('', [0, 0.0462, 0.0923, 0.0923, 0.1385, 0.1846]),
		}),
		new StatTableAscensionScale({
			stat: 'hp_base',
			base: 808.7586,
	...
	Jean: [
		...
		new StatTableAscensionScale({
			stat: 'healing_base',
			base: 0,
			ascension: new StatTable('', [0, 0.0554, 0.1108, 0.1108, 0.1662, 0.2215]),
		}),
		new StatTableAscensionScale({
			stat: 'hp_base',
			base: 1143.984,
	...
	Linnea: [
		new StatTableAscensionScale({
			stat: 'atk_base',
			base: 11.172,
			ascension: new StatTable('', [9.57828, 16.3839, 25.45806, 32.26368, 39.0693, 45.87492]),
			scale: charScales.s5atk,
		}),
		new StatTableAscensionScale({
			stat: 'burst_energy_cost',
		...
		new StatTableAscensionScale({
			stat: 'hp_base',
			base: 770.28253,
			ascension: new StatTable('', [660.44763, 1129.7131, 1755.4003, 2224.6658, 2693.9312, 3163.1965]),
			scale: charScales.s5hp,
		}),
		new StatTableAscensionScale({
			stat: 'mastery_base',
	...
	Mona: [
		...
		new StatTableAscensionScale({
			...
			base: 1,
			multi: 100,
			ascension: new StatTable('', [0, 0.08, 0.16, 0.16, 0.24, 0.32], 100),
		}),
	],
	Mualani: [
		new StatTableAscensionScale({
	...
	Noelle: [
		...
		new StatTableAscensionScale({
			stat: 'def_percent',
			base: 0,
			ascension: new StatTable('', [0, 0.075, 0.15, 0.15, 0.225, 0.3], 100),
		}),
		new StatTableAscensionScale({
			stat: 'hp_base',
			base: 1012.088,
	...
	Prune: [
		new StatTableAscensionScale({
			stat: 'atk_base',
			base: 18.52032,
			ascension: new StatTable('', [13.835952, 23.66676, 36.774506, 46.605312, 56.43612, 66.26693]),
			scale: charScales.s4atk,
		}),
		new StatTableAscensionScale({
			stat: 'atk_percent',
		...
		new StatTableAscensionScale({
			stat: 'hp_base',
			base: 811.494,
			ascension: new StatTable('', [606.22754, 1036.9681, 1611.2891, 2042.0297, 2472.7703, 2903.511]),
			scale: charScales.s4hp,
		}),
		new StatTableAscensionScale({
			stat: 'mastery_base',
	...
	Razor: [
		...
		new StatTableAscensionScale({
			stat: 'dmg_phys_base',
			base: 0,
			ascension: new StatTable('', [0, 0.075, 0.15, 0.15, 0.225, 0.3]),
		}),
		new StatTableAscensionScale({
			stat: 'hp_base',
			base: 1002.9701,
	...
	Sandrone: [
		...
		new StatTableAscensionScale({
			stat: 'def_base',
			base: 58.57357,
			ascension: new StatTable('', [50.2227, 85.90725, 133.48665, 169.1712, 204.85574, 240.5403]),
			scale: charScales.s5hp,
		}),
		new StatTableAscensionScale({
			stat: 'hp_base',
	...
	Xilonen: [
		...
		new StatTableAscensionScale({
			stat: 'def_percent',
			base: 0,
			ascension: new StatTable('', [0, 0.09, 0.18, 0.18, 0.27, 0.36], 100),
		}),
		new StatTableAscensionScale({
			stat: 'hp_base',
			base: 965.71313,
