...
import { CBaseBonusReaction, CMultiplierCustom, CSumPlusOne } from "../../Compile/Types/Block";
import { makeStatItem } from "../../Compile/Helpers";
import { FeatureReactionExtended } from "../Extended";
import { CConst } from "../../Compile/Types/Item";

export class FeatureReactionStellarConduct extends FeatureReactionExtended {
    constructor (params) {
        params.damageType ||= 'stellarconductreaction';
